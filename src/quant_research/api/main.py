...
def create_app(
    ...
    app.include_router(create_api_router(container.research, container.hypotheses, container.nse_importer, container.market_cache, container.nifty500_catalogue, container.artifacts, container.ml_research))
    return app
